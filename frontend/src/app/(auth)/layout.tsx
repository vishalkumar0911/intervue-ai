...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative min-h-[calc(100dvh-64px)]">
      {/* Background — reuse the project aesthetic */}
      ...
      {/* IMPORTANT: make auth pages full-width so our login page can use a wide grid */}
      <div className="mx-auto w-full max-w-8xl px-4 py-10 md:py-16">
        {children}
      </div>
    </div>
  );
